            ...
            def _update_epoch(update_state, unused, i):
                def _update_minbatch(train_state, batch_info, network_used):
                    ...
                    def _loss_fn(params, traj_batch, action_gae, comm_gae, targets, network_used, rng):
                        ...
                        # Use per-sample entropies so the communication loss actually reflects
                        # the correlation with the intrinsic advantages. Taking the mean before
                        # multiplying zeroed out the signal after normalization.
